...
SQL_INSERT_TEMPERATURE = "INSERT INTO sensor_reading (name, timestamp, value, uom) VALUES ('temperature', ?,?,'c')"
SQL_INSERT_HUMIDITY = "INSERT INTO sensor_reading (name, timestamp, value, uom) VALUES ('humidity',?,?,'%')"
